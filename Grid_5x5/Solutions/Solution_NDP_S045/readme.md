...
## Line Concept
![grid_network](Solutions/Solution_NDP_S045/Image/Line_Concept.jpg)
...
| OPERATING COST TOTAL									| sum of time and kilometer costs																												| 1998.00	| [$]	| 0700	| supply	|
...
| Characteristics of the Solution						| Description																																	| Value	| Unit 	| Time 	| Category	|
| --- 													| --- 																																			| ---	| ---	| ---	| ---		|
| MPJT - SHORTEST PATH 									| mean perceived journey time - shortest path, capacity constraints are not considered 															| 21.20	| [min]	| 0700	| demand	|
